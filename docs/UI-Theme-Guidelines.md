...
- Denne markdown-filen i repo (`docs/UI-Theme-Guidelines.md`).
- Minimum én SwiftUI-view (f.eks. `ThemedComponentsPreview`) som demonstrerer:
  - Background
  - Card
  - Primary button
...
Temaet er implementert i følgende filer:

- `Theme.swift` - Definerer farger, button styles og utility views
- `ThemedComponentsPreview.swift` - Demonstrerer alle tema-komponenter
- Alle views i appen bruker nå det nye temaet for konsistent utseende
